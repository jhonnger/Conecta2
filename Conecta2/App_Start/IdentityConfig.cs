...
namespace Conecta2
{
    ...
    public class UserManager : UserManager<MyUser, long>
    {
        public UserManager(IUserStore<MyUser, long> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new UserManager(new UserStore<MyUser, MyRole, long, MyLogin, MyUserRole, MyClaim>(context.Get<ApplicationDBContext>()));
            ...
            manager.RegisterTwoFactorProvider("Código telefónico", new PhoneNumberTokenProvider<MyUser, long>
            {
                MessageFormat = "Su código de seguridad es {0}"
            });
            manager.RegisterTwoFactorProvider("Código de correo electrónico", new EmailTokenProvider<MyUser, long>
            {
